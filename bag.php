...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-1.jpg" alt="Backpack" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <ul>
                <li>Clothing.</li>
                <li>Windproof/Waterproof/Rain gear.</li>
                <li>Sleeping Bag.</li>
                <li>Accessories.</li>
                <li>First-Aid cum medicine kit.</li>
                <li>Dry food to sustain a day in emergency condition.</li>
            </ul>
            <br>
    ...
    <section class="shop" id="shop">
        ...
        <div class="swiper product-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide">
                    <div class="image">
                        <img src="images/product-3.jpg" id="pole" alt="">
                    </div>
                    <div class="content">
                        <h3>Trekking Pole</h3>
