...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/raigad1.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <br>
                <br>
                <br>
                <h1>About Raigad</h1>
                <p id="para">Soaring to a height of around 820 metres, the captivating Raigad Fort is perched on the Sahyadri mountain range in Mahad, Maharashtra. The majestic fort is accessible only from one side through a pathway which has about 1737 steps as deep
                    valleys surround the other three sides. Alternatively, one can take the ropeway to reach the fort top in 4 minutes. The fort is of great pride for the Marathas and is a reminder of the bravery and audacity. The Raigad fort is not just
                    a tourist spot; it is a sacred place of pilgrimage which holds the imprints of the grand vision of Hindavi Swarajya as cherished by Chhatrapati Shivaji. While most of its parts are in ruins now, the fort still boasts of the brave history
                    of Marathas. After capturing the Raigad Fort, Chhatrapati Shivaji Maharaj renovated and named it as the capital of Maratha kingdom. The Britishers named it as the Gibraltar of the East as this well-fortified structure atop a hill had
                    defied various attackers. It has several beguiling gates Nagarkhana Darwaja, Mena Darwaja, Maha Darwaja and Palkhi Darwaja. </p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/raigad2.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" align="right" style="border-radius: 10px;">
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/raigad3.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
