...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-8.jpg" alt="rope" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <p class="price">&#8377;299</p>
            <ul>
                <li>Tie up your food. </li>
                <li>Fix broken pieces of your bag.</li>
                <li> Carry someone on a homemade stretcher.</li>
                <li>Tying down tents.</li>
                <li>for rescue, netting, or fishing. </li>
                <li> Relax in your own self-made hammock during the spring and summer seasons.</li>
            </ul>
            <br>
