...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-7.jpg" alt="Tent" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <ul>
                ...
                <li>Spacious, can sleep up to five people with their kit</li>
                <li> Excellent protection against the wind and rain.</li>
                <li>The canvas makes it better for regulating the temperature. </li>
                <li>Easy to set-up and transport. </li>
                <li> Lasts longer than the average tent due to its technical build.</li>
            </ul>
            <br>
