...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/torna1.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <br>
                <br>
                <br>
                <h1>About Torna</h1>
                <p id="para">Torna Fort is the highest hill-fort in the Pune District. Situated at an altitude of 4,603 ft from sea level, it stands out among other forts in the western ghats of Maharashtra. Because of the massive size of the fort, it is also called
                    Prachandagad. This name is derived from Marathi which means Prachanda – massive and gad – a fort. Torna fort was the first fort captured by Chhatrapati Shivaji Maharaj in 1646 when he was 16 years old. This is where the core of the
                    Maratha empire was built. It has a great history as it has gone under many rulers. In the 17th Century, the Mughal empire shortly gained control of the fort after Shivaji’s son Sambhaji got killed. The fort was renamed later by Aurangazeb(6th
                    Mughal Emperor) as Futulgaib in recognition of the difficult battle of the torma fort between Mughals and Marathas. Trek to the Torna fort unfolds many exciting things. You trek along the beautiful flower beds, on the top, there are
                    temples, water cisterns, Balekilla, 2 magnificent machis, Zunjar machi, and Budhla machi and a ridge connecting to Rajgad fort.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/torna2.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" align="right" style="border-radius: 10px;">
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/torna3.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
