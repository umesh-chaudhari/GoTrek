...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/garbett1.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <br>
                <br>
                <br>
                <h1>About Garbett</h1>
                <p id="para">Experience nature to the fullest and unwind your senses at Garbett Point Trek! Garbett Point Trek is an amazing destination to enjoy the beauty of nature. One can explore the lovely pathways, lush forests, fresh air, beautiful lake, waterfalls
                    with woodland sounds, serene lakes, and calm streams. Garbett Point Trek is a wonderful destination to be away from the noise and chaos of city life. Spend lazy afternoons strolling through verdant forests, and evening exploring the
                    majestic views of Matheran and Bhivpuri. Matheran is one of the smallest hill stations in India, Located at an elevation of 2625 feet above sea level. Mumbai and Pune are well connected by road and railway. Matheran proximity to both
                    cities makes it a popular weekend getaway. Matheran means forest on the forehead of the mountains is an eco-sensitive region. It is Asia’s only automobile free hill station. </p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/garbett2.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" align="right" style="border-radius: 10px;">
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/garbett3.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
