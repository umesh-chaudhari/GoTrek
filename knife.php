...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-2.jpg" alt="Survival Knife" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <ul>
                <li>Tent repairs.</li>
                <li>Rope cutting.</li>
                <li>Rescue from wild animals.</li>
                <li>Helps in ignition of fire.</li>
                <li>Process firewood.</li>
                <li>Prepare food like fruits and vegetables.</li>
            </ul>
            <br>
