...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-5.jpg" alt="D-ring Steel Hook" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <p class="price">&#8377;99</p>
            <ul>
                <li>attaching a climber to a rope. </li>
                <li>are super strong because our climbing safety depends on them.</li>
                <li>save your space in your package.</li>
                <li>very easy to operate and convenient for you to carry.</li>
                <li>playing great reliability under extreme operating conditions.</li>
                <li>hook is more solid, durable, and built to last, won't easily bend or break.</li>
            </ul>
            <br>
