...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-9.jpg" alt="Water Bottle" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <p class="price">&#8377;599</p>
            <ul>
                <li>cheap, durable, featherlight. </li>
                <li>fit into just about any water bottle pocket on any backpack..</li>
                <li> help keep the temperature for 1 hour Perfect for hiking.</li>
                <li>fitted with a shoulder strap or means for fastening it to a belt, and covered with a cloth bag.</li>
    ...
    <section class="footer" id="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="policindex.php">privacy policy</a>
            </div>
