...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="image">
            <img src="images/product-3.jpg" alt="Trekking Pole" style="width:100%">
        </div>
        ...
        <div class="content">
            ...
            <p class="price">&#8377;399 </p>
            <ul>
                <li>Protect knees,when walking down steep hills. </li>
                <li>Improve power and endurance when walking uphill.</li>
                <li>Aid balance on uneven trails.</li>
                <li>Reduce fatigue and improve endurance.</li>
                <li>Increase speed, especially going downhill.</li>
                <li>Strengthen muscles that support the spine.</li>
            </ul>
            <br>
            <a href="payment.php" class="btn">Buy Now</a> </div>
