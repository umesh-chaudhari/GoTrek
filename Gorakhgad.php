...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/gorakhgad1.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <br>
                <br>
                <br>
                <h1>About Gorakhad</h1>
                <p id="para">The Gorakhgad Fort is located in the Sahyadri Mountain Range in the Thane District of Maharashtra. It is nearly three hours away from Mumbai City and is one of the tougher treks located near the city of Mumbai. While very little is known
                    about the history of the Gorakhgad Fort, what we do know is that the fort was said to be of great importance during the reign of Shahaji Raje and during the time of Chatrapati Shivaji, the fort was primarily used as a stopover point
                    for the journey between Junnar to Naneghat. The fort itself seems to be built to serve two purposes, first, as a surveillance point and second as a pit stop for travellers.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/gorakhgad3.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" align="right" style="border-radius: 10px;">
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
                <img src="images/gorakhgad2.jpg" alt="responsive webite" class="img-fluid" height="500" width="800" style="border-radius: 10px;">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6" style="border:0px solid #ddd">
